...
- [ ] <font>final、static、private、构造方法无法被重写，final 修饰的方法可以被继承。</font>
- [ ] <font>实例方法不能覆盖静态方法，静态方法也不能隐藏实例方法。</font>
- [ ] <font>如果不能继承一个方法，则不能重写这个方法。</font>
